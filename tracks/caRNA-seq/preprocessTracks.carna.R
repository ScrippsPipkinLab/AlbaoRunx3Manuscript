...
bigwig_files <- c(  "mock"          = paste0(common_path, "scrnaseq/", "Base.bw"),
                    "shRunx3"       = paste0(common_path, "scrnaseq/", "Null.bw"),
                    "OE"            = paste0(common_path, "scrnaseq/", "WT.bw"),
                    "WTplus"        = paste0(common_path, "carna/", "WT_MOCK_REP1.plus.bigWig"),
                    "WTminus"       = paste0(common_path, "carna/", "WT_MOCK_REP1.minus.bigWig"),
                    "KOplus"        = paste0(common_path, "carna/", "RUNX3_FLFL_REP1.plus.bigWig"),
                    "KOminus"       = paste0(common_path, "carna/", "RUNX3_FLFL_REP1.minus.bigWig"),
                    "OEplus"        = paste0(common_path, "carna/", "RUNX3_OE_REP1.plus.bigWig"),
                    "OEminus"       = paste0(common_path, "carna/", "RUNX3_OE_REP1.minus.bigWig"),
                    ...
                    "Runx3.shCon"   = paste0(common_path, "cutnrun1/", "shCd19_Runx3_R1.bigWig"),
                    "Runx3.shR3"    = paste0(common_path, "cutnrun1/", "shRunx3_Runx3_R1.bigWig"),
                    "Runx1.shCon"   = paste0(common_path, "cutnrun1/", "shCd19_Runx1_R1.bigWig"),
                    "Runx1.shR3"    = paste0(common_path, "cutnrun1/", "shRunx3_Runx1_R1.bigWig")
                )
