...
all <- list(cnr_k4me3  = cnr_k4me3.samps,
            cnr_k36me3 = cnr_k36me3.samps,
            cnr_d5_runx3  = cnr_d5_runx3.samps,
            cnr_d5_runx1  = cnr_d5_runx1.samps,
            cnr_d8_runx3  = cnr_d8_runx3.samps,
            cnr_d8_runx1  = cnr_d8_runx1.samps,
            atc_d5        = atc_d5.samps,
            atc_d8        = atc_d8.samps
        )

# Define panel colors for the title panes of each autoscale group
group_color <- c(   cnr_k4me3  = "#4DBBD5",
                    cnr_k36me3 = "#F39B7F",
                    cnr_d5_runx3  = "#00A087",
                    cnr_d5_runx1  = "#8491B4",
                    cnr_d8_runx3  = "#00A087",
...
group_type <- c(    cnr_k4me3  = "polygon",
                    cnr_k36me3 = "polygon",
                    cnr_d5_runx3  = "polygon",
                    cnr_d5_runx1  = "polygon",
                    cnr_d8_runx3  = "polygon",
                    cnr_d8_runx1  = "polygon",
                    atc_d5        = "polygon",
                    atc_d8        = "polygon"
                )

# Define whether to fill zero-coverage gaps per autoscale group
group_densify <- c( cnr_k4me3     = TRUE,
                    cnr_k36me3    = TRUE,
                    cnr_d5_runx3  = TRUE,
                    cnr_d5_runx1  = TRUE,
                    cnr_d8_runx3  = TRUE,
...
dap_highlights <- c(    Runx3opened_GFPpos  = "#f8d9c4",     # red
...
plot_genes <- function(
    ...
    # pdf(paste0(gene,".tracks.pdf"), width = 8.5, height = 11)
    # # Plot the tracks
    # plotTracks( c(result.tracks$tracks, peak_track1, peak_track2, peak_track_atac),
...
plot_genes(gene = "Klf2")
plot_genes(gene = "Klf3")
